...
public class SCRUMTitleStepDefinition {
	...
	public void I_see_a_task_in_In_Progress_and_move_it_to_To_Do(
	...
	public void I_should_see_it_in_To_Do()
			throws Throwable {
		WebElement card = driver.find_element(By.XPATH, "*//tbody/tr[1]/td/div[contains(@class, 'card')]")
