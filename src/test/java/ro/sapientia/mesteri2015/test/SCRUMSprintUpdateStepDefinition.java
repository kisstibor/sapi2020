...
public class SCRUMSprintUpdateStepDefinition {
	...
	public void I_enter_in_the_title_textbox_and_I_push_the_update_button(String updateTitle) throws Throwable {
	    // Express the Regexp above with the code you wish you had
		WebElement addButton = WebDriverHelper.findElement(By.id("story-1"));
		addButton.click();
		//driver.wait(1000);
		WebElement updateButton = WebDriverHelper.findElement(By.id("action-update-button"));
		updateButton.click();
		//driver.wait(1000);
		WebElement titleField = WebDriverHelper.findElement(By.id("story-title"));
		titleField.sendKeys(Keys.CONTROL + "a");
		titleField.sendKeys(Keys.DELETE);
		titleField.sendKeys(updateTitle);
		
		WebElement updateStoryButton = WebDriverHelper.findElement(By.id("update-story-button"));
	...
	public void I_should_get_result_in_new_stories_list(String expectedResult) throws Throwable {
	    // Express the Regexp above with the code you wish you had
		WebElement titleText = WebDriverHelper.findElement(By.id("story-title"));
