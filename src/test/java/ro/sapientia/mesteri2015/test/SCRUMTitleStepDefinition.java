...
public class SCRUMTitleStepDefinition {
	...
	public void I_enter_in_the_title_textbox_and_I_push_the_add_button(
		...
		WebElement addButton = WebDriverHelper.findElement(By.id("add-button"));
		addButton.click();
		...
		WebElement searchButton = WebDriverHelper.findElement(By.id("add-story-button"));
		searchButton.click();
	}
	...
	public void I_should_get_result_in_stories_list(String expectedResult)
			throws Throwable {
		WebElement calculatorTextBox = WebDriverHelper.findElement(By.id("story-title"));
