...
public class StoryUpdateStepDefinition {
	...
	@When("^I enter \"([^\"]*)\" in the story point input and I push the update button$")
	public void I_enter_in_the_story_point_input_and_I_push_the_update_button(String updatePoint) throws Throwable {
	    // Express the Regexp above with the code you wish you had
		...
		pointInput.clear();
		pointInput.sendKeys(updatePoint);
	...
	public void I_should_get_result_in_new_stories_list(String expectedResult) throws Throwable {
	    // Express the Regexp above with the code you wish you had
		WebElement titleText = driver.findElement(By.id("story-point"));
